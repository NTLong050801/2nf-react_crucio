...
export default class About extends Component {
    state = {
        about_main: [
            { title: "RESPONSIVE", backgroundColor: "#ad00ff" },
            { title: "CUSTOMIZABLE", backgroundColor: "#8200bf" },
            { title: "MODERN", backgroundColor: "#56007f" },
        ]
    }
    render() {
            ...
            <div className='about' id='about'>
                <div className="about_text">
                    <div className="section-content text-center">
                        ...
                        <h2>WELCOME TO <strong className="color">CRUCIO</strong></h2>
                ...
                <div className="about_main">
                    {
                        about_main.map((item, index) => {
                            return (
                                <div className="about_main_cl" style={{ backgroundColor: item.backgroundColor }}>
